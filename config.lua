...
US_CONFIG = {
  {
    ...
    [ITEM_UPGRADE_CRYSTAL] = 26382, -- Upgrade Crystal item id
    [ITEM_ENCHANT_CRYSTAL] = 26383, -- Enchantment Crystal item id
    [ITEM_ALTER_CRYSTAL] = 26384, -- Alteration Crystal item id
    [ITEM_CLEAN_CRYSTAL] = 26385, -- Cleansing Crystal item id
    [ITEM_FORTUNE_CRYSTAL] = 26386, -- Fortune Crystal item id
    [ITEM_FAITH_CRYSTAL] = 26387 -- Faith Crystal item id
  },
  ITEM_MIND_CRYSTAL = 26388, -- Mind Crystal item id
  ITEM_LIMITLESS_CRYSTAL = 26389, -- Limitless Crystal item id
  ITEM_MIRRORED_CRYSTAL = 26390, -- Mirrored Crystal item id
  ITEM_VOID_CRYSTAL = 26391, -- Void Crystal item id
  ITEM_SCROLL_IDENTIFY = 26392, -- Scrol of Identification item id
  ITEM_UPGRADE_CATALYST = 26393, -- Upgrade Catalyst item id
  CRYSTAL_EXTRACTOR = 26394, -- Crystal Extractor item id
  CRYSTAL_FOSSIL = 26395, -- Crystal Fossil item id
  --
  ...
  --
  MAX_ITEM_LEVEL = 300, -- max that Gear Score can be assigned to item
  MAX_UPGRADE_LEVEL = 9, -- max level that item can be upgraded to,
  --
  ATTACK_PER_ITEM_LEVEL = 10, -- every X Gear Score +ATTACK_FROM_ITEM_LEVEL attack
  ATTACK_FROM_ITEM_LEVEL = 1, -- +X bonus attack for every ATTACK_PER_ITEM_LEVEL
  DEFENSE_PER_ITEM_LEVEL = 10, -- every X Gear Score +DEFENSE_FROM_ITEM_LEVEL defense
  DEFENSE_FROM_ITEM_LEVEL = 1, -- +X bonus defense for every DEFENSE_PER_ITEM_LEVEL
  ARMOR_PER_ITEM_LEVEL = 10, -- every X Gear Score +ARMOR_FROM_ITEM_LEVEL armor
  ARMOR_FROM_ITEM_LEVEL = 1, -- +X bonus armor for every ARMOR_PER_ITEM_LEVEL
  HITCHANCE_PER_ITEM_LEVEL = 10, -- every X Gear Score +HITCHANCE_FROM_ITEM_LEVEL hit chance
  HITCHANCE_FROM_ITEM_LEVEL = 1, -- +X bonus hit chance for every HITCHANCE_PER_ITEM_LEVEL
  --
  ITEM_LEVEL_PER_ATTACK = 6, -- +1 to Gear Score for every X Attack in item
  ITEM_LEVEL_PER_DEFENSE = 15, -- +1 to Gear Score for every X Defense in item
  ITEM_LEVEL_PER_ARMOR = 10, -- +1 to Gear Score for every X Armor in item
  ITEM_LEVEL_PER_HITCHANCE = 3, -- +1 to Gear Score for every X Hit Chance in item
  ITEM_LEVEL_PER_UPGRADE = 4, -- additional Gear Score per upgrade level
  --
  ...
  REQUIRE_LEVEL = true, -- block equipping items with higher Gear Score than Player Level
  RARITY = {
    [COMMON] = {
      name = "common",
...
US_UNIQUES = {
  [1] = {
    ...
    minLevel = 100, -- Required Gear Score to become Unique
  ...
  [2] = {
    ...
    minLevel = 40, -- Required Gear Score to become Unique
  ...
  [3] = {
    ...
    minLevel = 70, -- Required Gear Score to become Unique
